...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapDetailTaskProgress(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapDetailTaskDetail(BuildContext context) {
  ...
  onTapDetailTaskProgress(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.detailTaskProgressScreen);
  }

  onTapDetailTaskChat(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.detailTaskChatScreen);
  }

  onTapCreateTask(BuildContext context) {
